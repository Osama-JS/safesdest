...
class InvestorWalletExport implements FromCollection, WithHeadings, WithColumnWidths, WithTitle, WithEvents
{
    protected $wallet;
    protected $transactions;
    protected $investor;

    public function __construct(InvestorWallet $wallet, $transactions)
    {
        $this->wallet = $wallet;
        $this->transactions = $transactions;
        $this->investor = $wallet->investor;
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('C2', 'تقرير محفظة الاستثمار للمستثمر: ' . ($this->investor->name ?? 'غير محدد'));
                ...
                $sheet->setCellValue('D6', 'إجمالي الإيداعات:');
