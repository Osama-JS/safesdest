...
class CustomerWalletController extends Controller
{
    ...
    public function initiateRecharge(Request $request, \App\Http\Controllers\PaymentController $paymentController)
    {
        // Add required fields for PaymentController
        $request->merge([
            'purpose' => 'wallet_deposit',
        ]);

        $response = $paymentController->initiatePayment($request);
    ...
    public function checkRechargeStatus(Request $request, $id, \App\Http\Controllers\PaymentController $paymentController)
    {
        return $paymentController->getStatus($request, (int) $id);
    }
}
