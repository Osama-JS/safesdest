...
class Task extends Model
{
  ...
  /**
   * العلاقة مع المستثمر الذي دفع قيمة المهمة
   */
  ...
  /**
   * Scope: المهام المتاحة للدفع من محفظة مستثمر
   * (غير مقفلة، غير مدفوعة من مستثمر)
   */
  public function scopeAvailableForInvestorPayment($query)
  {
    return $query
