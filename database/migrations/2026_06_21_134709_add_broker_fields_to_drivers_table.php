...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('drivers', function (Blueprint $table) {
            ...
            $table->date('broker_commission_start_date')->nullable()->after('broker_commission_value');
    ...
    public function down(): void
    {
        Schema::table('drivers', function (Blueprint $table) {
            ...
            $table->dropColumn(['broker_id', 'broker_commission_type', 'broker_commission_value', 'broker_commission_start_date']);
        });
    }
};
