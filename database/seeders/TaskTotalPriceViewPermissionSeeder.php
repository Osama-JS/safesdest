...
class TaskTotalPriceViewPermissionSeeder extends Seeder
{
    /**
     * Run the database seeds.
     * Adds the 'view_task_total_price' permission under 'Tasks Permissions'.
    ...
    public function run(): void
    {
        ...
        $permission = Permission::updateOrCreate(
            ['name' => 'view_task_total_price', 'guard_name' => 'web'],
            [
                'd_name'  => 'View Task Total Price',
                'type_id' => $type->id,
            ]
        );
