...
$(function () {
  ...
  /**
   * معالج اختيار نوع المهمة من المودال الوسيط (للمهمات العادية/الميناء)
   */
  $('.task_type_template').on('click', function () {
    $('#regular-owner-wrapper').show();
    $('#submitModal').modal('show');
    $('#taskTypeModal').modal('hide');
  });

  /**
   * تم نقل منطق B2B بالكامل إلى b2b-task-modal.js
   * لضمان استقلال النظام وسهولة تعديله.
   */

  /**
   * معالج اختيار مالك المهمة (عميل أو إداري) للمهام العادية
   */
