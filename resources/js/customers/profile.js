...
$(document).on('click', '#delete_account_btn', function () {
  let url = baseUrl + 'customer/profile/delete/' + $(this).data('id');

  Swal.fire({
    title: `Delete My Account`,
    text: `Your account will be deleted, and you will no longer be able to log in to the platform.
            However, please note that the orders you have placed and your financial records will remain stored in the system
