        ...
        <div class="page-header fade-in">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 opacity-75">View and manage advertisement information and offers</p>
                </div>
                        ...
                        <div class="owner-info">
                            <div class="d-flex align-items-center">
                                <div class="owner-avatar">
                                    @php
                                        $ownerName =
                                            $task->owner == 'admin' ? $task->user->name : $task->customer->name;
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <span class="badge bg-label-{{ $task->owner == 'admin' ? 'primary' : 'success' }}">
                                        <i class="ti ti-{{ $task->owner == 'admin' ? 'user-shield' : 'user' }} me-1"></i>
                                        {{ $task->owner == 'admin' ? 'Admin User' : 'Customer' }}
                                    </span>
                                </div>
                                <div class="text-end">
