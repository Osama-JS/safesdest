...
@section('page-script')
    <script>
        const clearanceId = {{ $data->id }};
    </script>
    @vite(['resources/js/ajax.js'])
    @vite(['resources/js/model.js'])
    @vite(['resources/js/admin/customs-clearances/offers.js'])

@endsection
@section('customes-isactive', 'active')
@section('content')
        ...
        <div class="page-header fade-in">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 opacity-75">View and manage Customs Clearance information and offers</p>
                </div>
                        ...
                        <div class="owner-info">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <span class="badge bg-label-{{ $data->customer_id ? 'success' : 'primary' }}">
                                        <i class="ti ti-{{ $data->customer_id ? 'user' : 'user-shield' }} me-1"></i>
                                        {{ $data->customer_id ? 'Customer' : 'Admin User' }}
                                    </span>
                                </div>
                                <div class="text-end">
