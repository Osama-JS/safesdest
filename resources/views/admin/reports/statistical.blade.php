                        ...
                        <div class="col-md-12 mb-3 mt-2">
                            ...
                            <div class="d-flex gap-4">
                                <div class="form-check form-switch mb-2">
                                    <input class="form-check-input" type="checkbox" id="show_currency" name="show_currency" value="1">
                                    <label class="form-check-label" for="show_currency">{{ __('إظهار كلمة SAR / ريال في المبالغ') }}</label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="calc_net_commission" name="calc_net_commission" value="1" checked>
                                    <label class="form-check-label" for="calc_net_commission">{{ __('احتساب عمولة المنصة الصافية') }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
