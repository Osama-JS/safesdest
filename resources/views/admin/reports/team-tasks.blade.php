...
@section('title', __('Team Tasks Report'))
...
<!-- Page Scripts -->
@section('page-script')
    <script src="{{ asset('js/admin/reports/team-tasks.js') }}"></script>

    <script>
        // Set up routes for the JavaScript class
        window.routes = {
            preview: '{{ route('admin.reports.team-tasks.preview') }}',
            generate: '{{ route('admin.reports.team-tasks.generate') }}'
        };
        ...
        function initializeReport() {
            if (checkLibrariesLoaded()) {
                if (typeof TeamTasksReport !== 'undefined') {
                    console.log('All libraries loaded. Initializing TeamTasksReport...');
                    new TeamTasksReport();
                } else {
                    console.error('TeamTasksReport class not found');
                }
            } else {
    ...
    <div class="card mb-4">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-2">
                ...
                {{ __('Platform Reports') }} | {{ __('Team Tasks Report') }}
            </h5>
            <p>{{ __('Generate detailed reports for team tasks with customizable filters') }}
            </p>
        </div>
    </div>
                        ...
                        <form id="reportForm">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="team_ids" class="form-label">{{ __('Select Teams') }} <span
                            ...
                            <div class="row">
                                ...
                                <!-- Customer Selection -->
                                <div class="col-md-4 mb-3">
                                    <label for="customer_ids" class="form-label">{{ __('Select Customers') }}</label>
