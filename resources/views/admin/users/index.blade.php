                                        ...
                                        <div class="tab-pane fade show active" id="navs-justified-home" role="tabpanel">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="user-bank-name">{{ __('Bank Name') }}</label>
                                                ...
                                                <div class="col-md-4" id="user-custom-bank-field" style="display: none;">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="user-custom-bank-name">{{ __('Custom Bank Name') }}</label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="user-iban-number">{{ __('IBAN Number') }}</label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="user-bic-code">{{ __('BIC Code (Bank Identifier)') }}</label>
                                                        <input type="text" name="bic_code" id="user-bic-code"
                                                            class="form-control" placeholder="NCBKSAJE"
                                                            maxlength="20">
                                                        <div class="form-text">
                                                            <small
                                                                class="text-muted">{{ __('e.g., NCBKSAJE for SNB') }}</small>
                                                        </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="user-beneficiary-name">{{ __('Beneficiary Name (Official)') }}</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="user-bank-address1">{{ __('Bank Address 1') }}</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="user-bank-address2">{{ __('Bank Address 2') }}</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="user-bank-city">{{ __('Bank City') }}</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="user-bank-country">{{ __('Bank Country') }}</label>
