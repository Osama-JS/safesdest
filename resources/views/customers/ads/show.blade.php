...
@section('vendor-style')
    ...
    <style>
        /* Enhanced Customer Ad Details Page Styling */
        .customer-ad-details-page {
            background: #f8f9fa;
            min-height: 100vh;
        }
        ...
        /* Enhanced Offer Cards Styling for Customer */
        .offer-card {
            background: white;
            border: 1px solid #e7eef7;
            border-radius: 12px;
...
@section('content')
    <div class="customer-ad-details-page">
        <div class="container-fluid">
            ...
            <div class="page-header fade-in">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">View complete advertisement information and submitted offers</p>
                    </div>
                    <a href="{{ route('customer.ads.index') }}" class="back-btn">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12">
                    <!-- Enhanced Ad Details Card -->
                    <div class="enhanced-card mb-4 fade-in">
                        <div class="card-header">
                            <h5 class="mb-0 d-flex align-items-center">
                                <i class="ti ti-bullhorn me-2"></i>
                        ...
                        <div class="card-body">
                            ...
                            <div class="owner-info">
                                <div class="d-flex align-items-center">
                                    <div class="owner-avatar">
                                        {{ strtoupper(substr($task->owner == 'admin' ? $task->user->name : $task->customer->name, 0, 2)) }}
                                    </div>
                                    <div>
                                        <h6 class="mb-1">
                                            {{ $task->owner == 'admin' ? $task->user->name : $task->customer->name }}</h6>
                                        <p class="text-muted mb-0">
                                            <i class="ti ti-phone me-1"></i>
                                            {{ $task->owner == 'admin' ? $task->user->phone : $task->customer->phone }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                <h6 class="text-primary mb-3">
                                    <i class="ti ti-notes me-2"></i>{{ __('Advertisement Description') }}
                                </h6>
                                <div class="bg-light rounded p-3">
                                    <p class="mb-0 text-dark">
                                        {{ $ad->description ?: 'No description provided for this advertisement.' }}</p>
                                </div>
                            </div>
                    ...
                    <!-- Enhanced Pickup & Delivery Points -->
                    <div class="enhanced-card mb-4 fade-in">
                        <div class="card-header">
                            <h5 class="mb-0 d-flex align-items-center">
                                    ...
                                    <div class="location-card pickup">
                                        <div class="location-header">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h6 class="mb-0 ms-2">Pickup Point</h6>
                                            </div>
                                        ...
                                        <ul class="location-info">
                                            ...
                                            <li>
                                                <strong>Notes:</strong>
                                                <span>{{ optional($task->pickup)->note ?: 'No notes' }}</span>
                                            </li>
                                            @if (optional($task->pickup)->scheduled_time)
                                                <li>
                                                    <strong>Pickup Before:</strong>
                                                    <span>{{ \Carbon\Carbon::parse($task->pickup->scheduled_time)->format('Y-m-d H:i') }}</span>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
                                    ...
                                    <div class="location-card delivery">
                                        <div class="location-header">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h6 class="mb-0 ms-2">Delivery Point</h6>
                                            </div>
                                        ...
                                        <ul class="location-info">
                                            ...
                                            <li>
                                                <strong>Notes:</strong>
                                                <span>{{ optional($task->delivery)->note ?: 'No notes' }}</span>
                                            </li>
                                            @if (optional($task->delivery)->scheduled_time)
                                                <li>
                                                    <strong>Delivery Before:</strong>
                                                    <span>{{ \Carbon\Carbon::parse($task->delivery->scheduled_time)->format('Y-m-d H:i') }}</span>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
                    ...
                    <div class="offers-card fade-in">
                        <div class="offers-header">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="mb-0">Submitted Offers</h5>
                                    <small class="opacity-75">Driver proposals for this task</small>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modelTitle">
                            {{ $offer ? 'Update your offer' : 'Add your offer' }}
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form class="add-new-user pt-0 form_submit" method="POST"
                        action="{{ route('driver.offers.store') }}">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="mb-2">
                                <label class="form-label" for="price">* Your Price</label>

                                <input type="number" step="any" name="price"
                                    value="{{ $offer ? $offer->price : '' }}" min="0.00" id="offer-price"
                                    class="form-control" placeholder="Offer Price">
                            ...
                            <div class="mb-2">
                                ...
                                <textarea name="description" id="description" class="form-control" placeholder="Write your Notes or Description"
                                    rows="2">{{ $offer ? $offer->description : '' }}</textarea>
