...
@section('page-script')
    <script>
      const adId = {{ $ad->id }},
            adServiceCommissionType = "{{ $ad->pricing->service_commission_type }}",
            adServiceCommission = {{ $ad->pricing->service_commission ?? 0 }},
            adVatCommission = {{ $ad->pricing->vat_commission ?? 0 }};
    </script>

    @vite(['resources/js/customer/customs-clearances/offers.js'])
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-2">
                        ...
                        Customs Clearance Advertisement Details
                    </h2>
                    <p class="mb-0 opacity-75">View Customs Clearance details and submit your offer</p>
                </div>
            ...
            <div class="col-lg-7 col-md-12">
                                        ...
                                        <div class="price-item">
                                            ...
                                            <div>
                                                ...
                                                <div class="fw-bold text-success fs-5">
                                                  @if ($ad->total_price > 0)
                                                    {{ number_format($ad->total_price, 0) }} <small>SAR</small>
                ...
                @if ($ad->additional_data)
                    <div class="enhanced-card mb-4 fade-in">
                        ...
                        <div class="card-body">
                            @if (is_array($ad->driver_visible_additional_data) && count($ad->driver_visible_additional_data) > 0)
                                <div class="row g-3">
                                    @foreach ($ad->driver_visible_additional_data as $key => $field)
                        ...
                        <div class="p-3 ">
                            <div class="offer-alert">
                              ...
                              @endif
                                ...
                                @if ($offer->accepted && $ad->status === 'in_progress')
  ...
  <div class="modal fade " id="offerModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <form class="add-new-user pt-0 form_submit" method="POST" action="{{ route('customer.customs-clearances.offers.store') }}">
                    @csrf
