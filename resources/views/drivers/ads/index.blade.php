    ...
    <div class="driver-info-card">
        <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1">
                ...
                <p class="mb-0 text-muted">{{ auth()->user()->team->name ?? 'No Team Assigned' }}</p>
            </div>
            <div class="text-end">
                <div class="vehicle-size-badge">
                    <i class="ti ti-truck me-1"></i>
                    @php
                        $vehicle = auth()->user()->vehicle_size->type->vehicle->name ?? 'غير معروف';
                        $type = auth()->user()->vehicle_size->type->name ?? 'غير معروف';
                        $size = auth()->user()->vehicle_size->name ?? 'غير معروف';
                    @endphp

                    Vehicle: {{ $vehicle }} - {{ $type }} - {{ $size }}
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="card-title mb-2">
                        ...
                        {{ __('Available Task Advertisements') }}
                    </h5>
                    <p class="text-muted mb-0">Browse and submit offers for delivery tasks matching your vehicle size</p>
                </div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <small class="text-muted">Available Ads</small>
                </div>
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <h5 class="mb-1" id="vehicle-match">100%</h5>
                    <small class="text-muted">Vehicle Match</small>
                </div>
            </div>
        </div>
    </div>
