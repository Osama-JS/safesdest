...
<!-- Page Scripts -->
@section('page-script')
    @vite(['resources/js/driver/ads.js'])
...
@section('content')
    ...
    <div class="card-header border-bottom mb-3   d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="bx bx-bullhorn me-1"></i> {{ __('Ad Details') }}</h5>
    ...
    <div class="card-body">
            ...
            @if ($ad->highest_price)
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fw-bold text-danger">{{ number_format($ad->highest_price, 2) }} SAR</div>
                    </div>
                </div>
            @endif
            ...
            @if ($ad->lowest_price)
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fw-bold text-success">{{ number_format($ad->lowest_price, 2) }} SAR</div>
                    </div>
                </div>
            @endif
        ...
        <div>
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <div class="card-header bg-success text-white">العروض المقدمة</div>
                    <div class="card-body" id="offers-container">
                        <!-- سيتم ملء العروض هنا بالـ AJAX -->
                ...
                <!-- نموذج تقديم عرض -->
                <div class="card">
                    <div class="card-header bg-secondary text-white">قدم عرضك</div>
                    <div class="card-body">
                        <form id="offer-form">
                            @csrf
                            <input type="hidden" name="task_id" value="{{ $ad->task->id }}">
                            <div class="mb-2">
                                <input type="number" step="0.01" name="price" id="offer-price" class="form-control"
                                    placeholder="سعر العرض">
                            </div>
                            <div class="mb-2">
                                <textarea name="description" id="offer-description" class="form-control" placeholder="وصف العرض" rows="2"></textarea>
                            </div>
