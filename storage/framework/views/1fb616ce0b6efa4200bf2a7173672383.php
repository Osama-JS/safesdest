        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    ...
                    <?php echo e(__('Manage Signature')); ?>
            ...
            <div class="modal-body">
                ...
                <div id="signature-preview-container" class="text-center mb-4" style="display: none;">
                    <label class="form-label"><?php echo e(__('Current Signature')); ?></label>
                    <div class="border rounded p-3 bg-light">
                        <img id="current-signature" src="" alt="<?php echo e(__('Current Signature')); ?>"
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="tab-draw-signature" role="tabpanel">
                        <div class="signature-pad-container">
                            <label class="form-label"><?php echo e(__('Draw your signature below')); ?></label>
                    ...
                    <div class="tab-pane fade" id="tab-upload-signature" role="tabpanel">
                        <div class="mb-3">
                            <label class="form-label"><?php echo e(__('Upload signature image')); ?></label>
                            <input type="file" class="form-control" id="signature-file"
                                accept="image/png,image/jpeg,image/jpg,image/gif">
                            <small class="form-text text-muted">
                                <?php echo e(__('Supported formats: PNG, JPG, GIF. Recommended: transparent PNG.')); ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-label-danger me-auto" id="delete-signature" style="display: none;">
                    ...
                    <?php echo e(__('Delete Signature')); ?>
...
<script>
    window.signatureModalManager = (function() {
        ...
        function openModal(type, id) {
            ...
            fetch(`<?php echo e(route('admin.signature.get')); ?>?type=${type}&id=${id}`)
                .then(res => res.json())
                .then(data => {
        ...
        function saveSignature() {
            ...
            if (activeTab === 'tab-draw-signature') {
                if (signaturePad.isEmpty()) {
                    Swal.fire({
                        icon: 'warning',
                        title: '<?php echo e(__("Please draw your signature")); ?>',
                ...
                if (!file) {
                    Swal.fire({
                        icon: 'warning',
                        title: '<?php echo e(__("Please select a file")); ?>',
                        showConfirmButton: false,
                        timer: 1500
                    });
                    return;
            ...
            // Show loading
            Swal.fire({
                title: '<?php echo e(__("Saving...")); ?>',
                allowOutsideClick: false,
                didOpen: () => Swal.showLoading()
            });

            fetch('<?php echo e(route("admin.signature.upload")); ?>', {
                    method: 'POST',
                    body: formData
                })
                .then(res => res.json())
                .then(data => {
                    if (data.success) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: data.message || '<?php echo e(__("Error saving signature")); ?>'
                        });
                    }
                })
                .catch(err => {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: '<?php echo e(__("Error saving signature")); ?>'
                    });
                });
        }
        ...
        function deleteSignature() {
            Swal.fire({
                ...
                text: '<?php echo e(__("This will delete the signature")); ?>',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('<?php echo e(route("admin.signature.delete")); ?>', {
                            method: 'POST',
                            headers: {
...
<?php /**PATH C:\xampp\htdocs\safedestssss\resources\views/admin/partials/signature-modal.blade.php ENDPATH**/ ?>