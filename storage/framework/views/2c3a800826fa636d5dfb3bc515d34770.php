<?php $__env->startSection('title', 'إدارة طلبات سحب العمولات للمستثمرين'); ?>
...
<div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.investors.index')); ?>">المستثمرون</a></li>
            ...
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="ms-1 mb-0"><?php echo e($stats['total']); ?></h4>
                    </div>
            ...
            <div class="card h-100 border-0 shadow-sm" style="border-top: 3px solid #ffab00 !important;">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="ms-1 mb-0 text-warning"><?php echo e($stats['pending']); ?></h4>
                    </div>
            ...
            <div class="card h-100 border-0 shadow-sm" style="border-top: 3px solid #28a745 !important;">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="ms-1 mb-0 text-success"><?php echo e($stats['approved']); ?></h4>
                    </div>
            ...
            <div class="card h-100 border-0 shadow-sm" style="border-top: 3px solid #7367f0 !important;">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="ms-1 mb-0 text-info"><?php echo e(number_format($stats['total_approved_amount'], 2)); ?></h4>
                    </div>
    ...
    <div class="card mb-4 border-0 shadow-sm">
        <div class="card-body py-3">
            <form method="GET" action="<?php echo e(route('admin.investors.commission-withdrawals.index')); ?>" class="row g-3 align-items-end">
                <div class="col-md-4">
                    <label class="form-label small fw-bold">بحث بالمستثمر</label>
                    <input type="text" name="search" class="form-control" placeholder="اسم المستثمر، البريد، أو رقم الهاتف..." value="<?php echo e(request('search')); ?>">
                </div>
                <div class="col-md-2">
                    ...
                    <select name="status" class="form-select">
                        ...
                        <option value="approved" <?php echo e(request('status') === 'approved' ? 'selected' : ''); ?>>مقبول ومصروف</option>
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <?php if(request()->anyFilled(['search', 'status', 'date_from', 'date_to'])): ?>
                        <a href="<?php echo e(route('admin.investors.commission-withdrawals.index')); ?>" class="btn btn-label-secondary" title="إعادة تعيين">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="fw-bold">#<?php echo e($w->id); ?></td>
                        <td>
                            <?php if($w->user): ?>
                                <div class="d-flex align-items-center">
                                    <div>
                                        <a href="<?php echo e(route('admin.user-wallets.show', $w->user->id)); ?>" class="fw-bold text-heading text-decoration-none">
                                            <?php echo e($w->user->name); ?>

                                        </a>
                                        <div class="text-muted small"><?php echo e($w->user->phone ?: $w->user->email); ?></div>
                                    </div>
                                </div>
                            <?php else: ?>
                        ...
                        <td>
                            <strong class="text-primary fs-6"><?php echo e(number_format($w->amount, 2)); ?></strong>
                        ...
                        <td>
                            ...
                            ?>
                            <span class="badge <?php echo e($withdrawable >= $w->amount ? 'bg-label-success' : 'bg-label-danger'); ?>">
                                <?php echo e(number_format($withdrawable, 2)); ?> ر.س
                            </span>
                        </td>
                        <td>
                            <?php if($w->bank_name || $w->iban_number): ?>
                                <div class="fw-medium small"><?php echo e($w->bank_name ?: 'غير محدد'); ?></div>
                                <div class="font-monospace small text-muted" style="font-size: 0.78rem;"><?php echo e($w->iban_number ?: $w->account_number); ?></div>
                                <?php if($w->account_holder): ?>
                                    <small class="text-muted"><?php echo e($w->account_holder); ?></small>
                                <?php endif; ?>
                            <?php else: ?>
                        ...
                        <td>
                            <div><?php echo e($w->created_at->format('Y-m-d')); ?></div>
                            <small class="text-muted"><?php echo e($w->created_at->format('H:i')); ?></small>
                        </td>
                        ...
                        <td>
                            <?php if($w->receipt_image): ?>
                                <button type="button" class="btn btn-xs btn-label-info mb-1" onclick="previewReceipt('<?php echo e($w->receipt_url); ?>')">
                                    <i class="ti ti-file-certificate me-1"></i> الإيصال
                                </button>
                            <?php endif; ?>

                            <?php if($w->status === 'rejected' && $w->rejection_reason): ?>
                                <div class="text-danger small fw-medium" title="<?php echo e($w->rejection_reason); ?>">
                                    <i class="ti ti-alert-circle me-1"></i><?php echo e(\Illuminate\Support\Str::limit($w->rejection_reason, 35)); ?>

                                </div>
                            <?php endif; ?>

                            <?php if($w->admin_notes): ?>
                                <div class="text-muted small" style="font-size: 0.75rem;"><?php echo e(\Illuminate\Support\Str::limit($w->admin_notes, 30)); ?></div>
                            <?php endif; ?>
                        </td>
                        <td class="text-center">
                            <?php if($w->status === 'pending'): ?>
                                <div class="d-flex justify-content-center gap-1">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['approve_investor_withdrawals', 'manage_investor_withdrawals', 'save_investors'])): ?>
                                    <button type="button" class="btn btn-sm btn-success px-2"
                                            onclick="openApproveModal(
                                                <?php echo e($w->id); ?>,
                                                '<?php echo e(addslashes($w->user?->name ?? '—')); ?>',
                                                '<?php echo e(addslashes($w->user?->phone ?: ($w->user?->email ?? '—'))); ?>',
                                                <?php echo e($w->amount); ?>,
                                                <?php echo e($withdrawable); ?>,
                                                '<?php echo e(addslashes($w->bank_name ?: 'غير محدد')); ?>',
                                                '<?php echo e(addslashes($w->account_holder ?: ($w->user?->name ?? 'غير محدد'))); ?>',
                                                '<?php echo e(addslashes($w->iban_number ?: ($w->account_number ?: 'غير محدد'))); ?>',
                                    ...
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['reject_investor_withdrawals', 'manage_investor_withdrawals', 'save_investors'])): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('approve_investor_withdrawals')): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('manage_investor_withdrawals')): ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('save_investors')): ?>
                            ...
                            <?php else: ?>
                                <span class="text-muted small">
                                    <?php echo e($w->processor?->name ? 'عبر: ' . $w->processor->name : 'مكتمل'); ?>
...
<script>
    ...
    document.getElementById('approveWithdrawalForm').addEventListener('submit', function (e) {
        ...
        fetch(`<?php echo e(url('admin/investors/commission-withdrawals')); ?>/${id}/approve`, {
            method: 'POST',
            headers: {
    ...
    document.getElementById('rejectWithdrawalForm').addEventListener('submit', function (e) {
        ...
        fetch(`<?php echo e(url('admin/investors/commission-withdrawals')); ?>/${id}/reject`, {
            method: 'POST',
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\safedestssss\resources\views/admin/commissions/withdrawals.blade.php ENDPATH**/ ?>