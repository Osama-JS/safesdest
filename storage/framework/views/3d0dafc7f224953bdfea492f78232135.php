...
window.sendNotification = function() {
    ...
    if (!endpoint) {
        if (targetType === 'driver') {
            endpoint = '<?php echo e(route("admin.notifications.send.driver")); ?>';
            formData.append('driver_id', targetId);
        } else if (targetType === 'customer') {
            endpoint = '<?php echo e(route("admin.notifications.send.customer")); ?>';
            formData.append('customer_id', targetId);
        } else if (targetType === 'task') {
            endpoint = '<?php echo e(route("admin.notifications.send.task.driver")); ?>';
            formData.append('task_id', targetId);
        } else if (targetType === 'task-customer') {
            endpoint = '<?php echo e(route("admin.notifications.send.task.customer")); ?>';
            formData.append('task_id', targetId);
        }
    }
...
<?php /**PATH C:\xampp\htdocs\safedestssss\resources\views/admin/partials/notification-modal.blade.php ENDPATH**/ ?>