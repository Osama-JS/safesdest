            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <select id="filter_status" class="form-select">
                        ...
                        <option value="pending_approval" selected><?php echo e(__('بانتظار المصادقة (تحتاج قرار)')); ?></option>
                    ...
                    <div id="payout-details-content" style="display: none;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12" id="modal-image-container" style="display: none;">
                                <h6 class="fw-bold mb-2"><i class="ti ti-photo me-1"></i> <?php echo e(__('مرفق السند')); ?></h6>
                                <div class="text-center p-2 border rounded">
                                    <a id="modal-image-link" href="#" target="_blank">
                                        <img id="modal-image-preview" src="#" alt="<?php echo e(__('سند التحويل')); ?>" class="img-fluid rounded" style="max-height: 200px;">
                                    </a>
                                </div>
                            </div>
                        </div>
