    ...
    <div class="modal-dialog modal-fullscreen" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="modelTitle"><?php echo e(__('Add New Tasks')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
                <form class="form_submit pt-0 " id="task-form" method="POST" action="<?php echo e(route('tasks.create')); ?>"
                        ...
                        <div class="col-md-5">
                            ...
                            <div id="force-update-notice" class="alert alert-warning py-2 mb-3" style="display: none;">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <strong><?php echo e(__('وضع التعديل الإجباري للمهمة')); ?></strong>: <?php echo e(__('نوع وحجم المركبة مقفل للحفاظ على سلامة التكليف، ويمكنك تعديل باقي بيانات المهمة.')); ?>
                            ...
                            <ul class="nav nav-tabs" id="taskTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="tab-step1" data-bs-toggle="tab"
                                        data-bs-target="#step1" type="button" role="tab"><?php echo e(__('Step 1')); ?></button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link disabled" id="tab-step2" data-bs-toggle="tab"
                                        data-bs-target="#step2" type="button" role="tab"><?php echo e(__('Step 2')); ?></button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link disabled" id="tab-step3" data-bs-toggle="tab"
                                        data-bs-target="#step3" type="button" role="tab"><?php echo e(__('Step 3')); ?></button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content mt-3">
                                ...
                                <div class="tab-pane fade show active" id="step1" role="tabpanel">
                                    ...
                                    <div id="regular-owner-wrapper">
                                        <label for="task-owner" class="form-label">* <?php echo e(__('owner type')); ?></label>
                                        <select name="owner" id="task-owner" class="form-select">
                                            <option value="admin"><?php echo e(__('Administrator')); ?></option>
                                        ...
                                        <div id="customers-wrapper" class="mt-2" style="display: none;">
                                            <label for="task-customer" class="form-label">*
                                                <?php echo e(__('Select Customer')); ?></label>
                                            <select name="customer" id="task-customer" class="form-select select2">
                                                ...
                                                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($val->id); ?>"
                                                        data-notes="<?php echo e($val->general_task_notes ?? ''); ?>">
                                                        <?php echo e($val->name); ?>
                                    ...
                                    <div class="mb-3">
                                        <div class="divider text-start">
                                            <div class="divider-text"><strong><?php echo e(__('Task Information')); ?></strong>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="created_at"><?php echo e(__('Created At')); ?></label>
                                    ...
                                    <button type="button" id="go-to-step2" class="btn btn-primary mt-3"><?php echo e(__('Next')); ?>
                                    ...
                                    <div class="mb-3">
                                        <div class="divider text-start">
                                            <div class="divider-text">
                                                <strong><?php echo e(__('(Pickup / Delivery) Point')); ?></strong></div>
                                        </div>
                                            ...
                                            <div class="accordion-item">
                                                <h4 class="accordion-header text-body d-flex justify-content-between"
                                                    ...
                                                    <button type="button" class="accordion-button collapsed"
                                                        ...
                                                        <h5> <?php echo e(__('Pickup Point')); ?></h5>
                                                    </button>
                                                </h4>
                                                        ...
                                                        <div class="mb-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="text" id="pickup-contact-name"
                                                                            ...
                                                                            placeholder="<?php echo e(__('Enter pickup address')); ?>"
                                                                            required />
                                                                        <span
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="pickup-before">*
                                                                            <?php echo e(__('Pickup before')); ?></label>
                                                            ...
                                                            <div class="mb-3" id="pickup-map-section">
                                                                ...
                                                                <label for="pickup-location">*
                                                                    <?php echo e(__('Location')); ?></label>
                                                                <div class="input-group mb-2">
                                                                    <div class="form-control p-0" id="pickup-geocoder">
                                                                    </div>
                                                                    <button type="button" title="<?php echo e(__('Parse link')); ?>"
                                                                        id="pickup-toggle-link-input"
                                                                        class="input-group-text bg-white">
                                                                        <i class="fas fa-link text-secondary"></i>
                                                                    </button>
                                                                    <button type="button"
                                                                        title="<?php echo e(__('Manual entry')); ?>"
                                                                        id="pickup-manual-btn"
                                                                        class="input-group-text bg-white">
                                                                        <i class="fas fa-globe text-secondary"></i>
                                                                    </button>
                                                                    <button type="button"
                                                                        title="<?php echo e(__('My current location')); ?>"
                                                                ...
                                                                <div id="pickup-link-input-wrapper" class="mt-2"
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="text" id="pickup-map-link"
                                                                            class="form-control"
                                                                            placeholder="<?php echo e(__('Paste map link here')); ?>" />
                                                                        <button type="button" id="pickup-parse-link"
                                                                            class="btn btn-secondary">
                                                                            <?php echo e(__('Parse Link')); ?>
                                                            ...
                                                            <!-- Note -->
                                                            <div class="mb-3">
                                                                <label for="pickup-note"><?php echo e(__('Note')); ?></label>
                                                                <input type="text" id="pickup-note" name="pickup_note"
                                                                    class="form-control"
                                                                    placeholder="<?php echo e(__('Note')); ?>" />
                                                                <span
                                                            ...
                                                            <div class="mb-6">
                                                                <label
                                                                    for="pickup-image"><?php echo e(__('Image for pickup address')); ?></label>

                                                                <div class="form-group mt-2">
                                                                    <img src="<?php echo e(url(asset('assets/img/placeholder.jpg'))); ?>"
                                                                        data-image="<?php echo e(url(asset('assets/img/placeholder.jpg'))); ?>"
                                                ...
                                                <h4 class="accordion-header text-body d-flex justify-content-between"
                                                    ...
                                                    <button type="button" class="accordion-button collapsed"
                                                        ...
                                                        <i class="ri-bar-chart-2-line me-2 ri-20px"></i>
                                                        <h5> <?php echo e(__('Delivery Point')); ?></h5>
                                                    </button>
                                                </h4>
                                                        ...
                                                        <div class="mb-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="text" id="delivery-contact-name"
                                                                            ...
                                                                            placeholder="<?php echo e(__('Enter delivery name')); ?>"
                                                                            required />
                                                                        <span
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="number" id="delivery-contact-phone"
                                                                            ...
                                                                            placeholder="<?php echo e(__('Enter delivery phone')); ?>"
                                                                            required />
                                                                        <span
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="delivery-before">*
                                                                            <?php echo e(__('Delivery before')); ?></label>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" id="delivery-address"
                                                                    ...
                                                                    placeholder="<?php echo e(__('Enter delivery address')); ?>"
                                                                    required />
                                                                <span
                                                            ...
                                                            <!-- Note -->
                                                            <div class="mb-3">
                                                                <label for="delivery-note"><?php echo e(__('Note')); ?></label>
                                                            ...
                                                            <div class="mb-6">
                                                                <label
                                                                    for="delivery-image"><?php echo e(__('Image for pickup address')); ?></label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <button type="button" id="back-to-step1" class="btn btn-light mt-3"><i
                                                    class="ti ti-arrow-left"></i><?php echo e(__('Back')); ?>

                                            </button>
                                            <button type="button" id="go-to-step3"
                                                class="btn btn-primary mt-3 mx-2"><?php echo e(__('Next')); ?>
                                ...
                                <div class="tab-pane fade" id="step3" role="tabpanel">
                                    ...
                                    <div class="mb-3">
                                        <label for=""><?php echo e(__('Do you have any Conditions')); ?>?</label>
                                        <textarea name="conditions" id="conditions" class="form-control" rows="3"
                                            placeholder="<?php echo e(__('Write your Conditions')); ?>"></textarea>
                                    ...
                                    <div id="assign-section" style="display: none">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-group">
                                                <label for=""><?php echo e(__('Assign Driver')); ?></label>
                                                <div class="row">
                                                    <div class="com-md-6">
                                                        <input type="checkbox" id="driver-manual"
                                                            name="driver_assign_type" value="manual"
                                                            class="form-checkbox">
                                                        <label for="driver-manual"><?php echo e(__('Assign Manually')); ?></label>
                                                        <div>
                                    ...
                                    <button type="submit" id="go-to-step2"
                                        class="btn btn-primary mt-3 mx-2"><?php echo e(__('Submit')); ?></button>
...
<div class="modal fade " id="assignModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <form class="add-new-user pt-0 form_submit" method="POST" action="<?php echo e(route('tasks.assign')); ?>">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="col-xl-12">
                        <div class="nav-align-top">
                            <div class="tab-content">
                                <div class="tab-pane fade show active">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label" for="team-name">* <?php echo e(__('Driver')); ?></label>
...
<div class="modal fade " id="adModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="adTitle"><?php echo e(__('Edit Task Ad')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form class="add-new-user pt-0 form_submit" method="POST" action="<?php echo e(route('ads.update')); ?>">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    ...
                    <div class="alert alert-info mb-3 d-flex flex-column" role="alert" style="max-width: 600px;">
                        <div class="form-check mb-2">
                            ...
                            <label class="form-check-label fw-bold"
                                for="not-price"><?php echo e(__('Including VAT and service charge')); ?></label>
                        </div>

                        <p class="small text-muted">
                            <?php echo e(__('If you do not select this option, both the VAT and the service commission will be calculated on top of the amount you display.')); ?>
                    ...
                    <div class="mb-3 row">
                        <div class="col-md-6">
                            <label for="min-price">* <?php echo e(__('Min Price')); ?></label>
                        ...
                        <div class="col-md-6">
                            <label for="max-price">* <?php echo e(__('Max Price')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="not-price"><?php echo e(__('Note')); ?></label>
...
<div class="modal fade " id="pricingModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="pricingTitle"><?php echo e(__('Edit Task Pricing')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form class="add-new-user pt-0 form_submit" method="POST" action="<?php echo e(route('tasks.pricing.update')); ?>">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for=""><?php echo e(__('Set the total price Manual')); ?></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for=""><?php echo e(__('Set driver price Manual')); ?></label>
        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body text-center d-flex flex-column gap-3 py-4">
                ...
                <button
                    ...
                    data-template="<?php echo e($task_template?->value); ?>">
                    <i class="fas fa-tasks"></i>
                    <span>إنشاء مهمة داخلية</span>
                </button>

                <?php if(($task_to_template->value ?? null) !== null): ?>
                    ...
                    <button
                        ...
                        data-template="<?php echo e($task_to_template?->value); ?>">
                ...
                <?php if(($task_from_template->value ?? null) !== null): ?>
                    ...
                    <button
                        ...
                        data-template="<?php echo e($task_from_template?->value); ?>">
...
<div class="modal fade " id="addNoteModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addNoteTitle"><?php echo e(__('Edit Task Pricing')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="<?php echo e(route('tasks.note')); ?>" method="POST" class="card shadow-sm p-4 border-0 form_submit"
                enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    <label for="description" class="form-label"><?php echo e(__('Add Note')); ?></label>
                    <textarea name="description" id="description" class="form-control" rows="3"
                        placeholder="<?php echo e(__('Type the note here')); ?>..."></textarea>
                    <span class="description-error text-danger text-error"></span>
                </div>

                <div class="mb-3">
                    <label for="file" class="form-label"><?php echo e(__('Upload File')); ?>
...
<div class="modal fade" id="duplicateModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="duplicateModalTitle"><?php echo e(__('Duplicate Task')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo e(__('Close')); ?>"></button>
            </div>
            <form class="form_submit" method="POST" action="<?php echo e(route('tasks.duplicate')); ?>">
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary"><?php echo e(__('Duplicate')); ?></button>
                </div>
            </form>
        </div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#submitModal').on('shown.bs.modal', function () {
            $('#task-customer').select2({
                ...
                width: '100%',
                placeholder: "<?php echo e(__('Select Customer')); ?>",
                allowClear: true
            });
        });
    });
</script><?php /**PATH C:\xampp\htdocs\safedestssss\resources\views/admin/tasks/from-modal.blade.php ENDPATH**/ ?>