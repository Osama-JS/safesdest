    ...
    <div class="container-xxl">
        ...
        <div class="nav-item dropdown-language dropdown" style="position: fixed; right: 0px; top: 20px; z-index: 1000;">
            <button type="button" class="btn btn-light "
                ...
                <i class="fas fa-headset text-primary fs-5 mx-2"></i> <?php echo e(__('Help')); ?>
                ...
                <div class="modal-content shadow-lg border-0 rounded-4">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title fw-bold text-center" id="helpModalLabel">
                            <i class="fas fa-headset me-2"></i> <?php echo e(__('Contact, Complaints and Suggestions')); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <a href="https://www.safedest.com" target="_blank"
                                    ...
                                    <div class="fw-bold"><?php echo e(__('Website')); ?></div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="mailto:Info@safedest.com"
                                    ...
                                    <div class="fw-bold"><?php echo e(__('Email')); ?></div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <a href="tel:0556978782"
                                    ...
                                    <div class="fw-bold"><?php echo e(__('First Number')); ?></div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="tel:0545366466"
                                    ...
                                    <i class="bi bi-telephone-fill text-danger fs-3 mb-2 d-block"></i>
                                    <div class="fw-bold"><?php echo e(__('Second Number')); ?></div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="app-brand justify-content-center mb-4">
                            <a href="<?php echo e(url('/')); ?>" class="app-brand-link">
                                ...
                                <span class="app-brand-text demo text-heading fw-bold"
                                    style="color: #2c3e50;"><?php echo e(config('variables.templateName')); ?></span>
                            </a>
                        </div>
                        <!-- /Logo -->

                        <div class="login-header">
                            <h4><?php echo e(__('Welcome to')); ?> <?php echo e(config('variables.templateName')); ?>! 👋</h4>
                            <p><?php echo e(__('Welcome to the page dedicated to')); ?></p>
                            <p><?php echo e(__('companies, factories, brokers, transporters, and customs clearance agents')); ?></p>
                        </div>
                        ...
                        <form id="formAuthentication" action="<?php echo e(route('login')); ?>" method="POST">
                            ...
                            <div class="account-type-section">
                                <h6 class="account-type-title my-3"><?php echo e(__('Choose Your Account Type')); ?></h6>
                                <div class="account-types-grid">
                                    <div class="account-type-card">
                                        ...
                                        <label for="customer" class="account-type-label">
                                            ...
                                            <span class="account-type-title"><?php echo e(__('Customer')); ?></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="account-type-card">
                                        ...
                                        <label for="driver" class="account-type-label">
                                            ...
                                            <span class="account-type-title"><?php echo e(__('Driver')); ?></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="account-type-card">
                                        ...
                                        <label for="broker" class="account-type-label">
                                            ...
                                            <span class="account-type-title"><?php echo e(__('Customs Broker')); ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <label for="login-email">
                                    <i class="ti ti-mail me-2"></i><?php echo e(__('Email Address')); ?>

                                </label>
                                <div class="validation-message">
                                    <i class="ti ti-alert-circle me-1"></i><?php echo e(__('Please enter a valid email address')); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <div class="invalid-feedback">
                                        <i class="ti ti-alert-circle me-1"></i><?php echo $message; ?>
...
unset($__errorArgs, $__bag); ?>" name="password"
                                ...
                                <label for="login-password">
                                    <i class="ti ti-lock me-2"></i><?php echo e(__('Password')); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex justify-content-end mb-4">
                                <?php if(Route::has('password.request')): ?>
                                    <a href="<?php echo e(route('password.request')); ?>" class="forgot-password-link">
                                        <i class="ti ti-help me-1"></i><?php echo e(__('Forgot Password?')); ?>
                        ...
                        <div class="register-link">
                            <span class="text-muted"><?php echo e(__('New on our platform?')); ?></span>
                            <a href="<?php echo e(route('auth.register')); ?>">
                                <i class="ti ti-user-plus me-1"></i><?php echo e(__('Create an account')); ?>
                ...
                <div class="text-center mt-3">
                    <span class="text-muted"><?php echo e(__('Are You Team Leader?')); ?></span>
                    <a href="<?php echo e(url('admin-panel/login')); ?>">
                        <?php echo e(__('Sign In From Here')); ?>
...
<?php echo $__env->make('layouts/blankLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\safedestssss\resources\views/auth/custom-login.blade.php ENDPATH**/ ?>